  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-slate-800 uppercase tracking-tight">Product Management</h2>
          <p className="text-slate-500 text-sm mt-1">Employee access to product catalog.</p>
        </div>
